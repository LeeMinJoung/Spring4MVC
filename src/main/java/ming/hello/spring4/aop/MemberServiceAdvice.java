...
import ming.hello.spring4.controller.BoardController;
...
public class MemberServiceAdvice {
    ...
    @Pointcut("execution(* ming.hello.spring4.controller.MemberController.myinfo(..))")
    public void myinfoPoint() {}

    @Pointcut("execution(* ming.hello.spring4.controller.MemberController.join(..))")
